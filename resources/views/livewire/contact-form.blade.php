<div>
    ...
    <form wire:submit="submit" class="space-y-4">
        <div class="grid sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="prenom" wire:model="prenom"
                       class="w-full rounded-lg border border-stone-300 px-4 py-2 shadow-sm focus:border-apcq focus:ring-1 focus:ring-apcq"
                       required>
                @error('prenom')
        ...
        <button type="submit"
                class="w-full sm:w-auto px-6 py-2 bg-apcq text-white font-medium rounded-lg hover:bg-apcq-dark transition">
            Envoyer
        </button>
    </form>
</div>
